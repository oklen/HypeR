...
def _run_thread(arguments):
    ...
    # searcher = SimpleSearcher.from_prebuilt_index(index)
    searcher = SimpleSearcher(index)
    searcher.object.setBM25(0.9, 0.4)
    ...
    for x in _iter:
        ...
        for y in hits:
            ...
            #     print(e)
            json_y = json.loads(y.raw)
            element.append(
                {
                    "score": y.score,
                    "text": json_y['contents'],
...
class BM25(Retriever):
    ...
    def run(self):
        ...
        print(f"Pool Size:{self.num_threads}")
